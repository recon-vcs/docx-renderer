import { ParagraphProperties, parseParagraphProperties } from '@docx/ooxml/wordprocessingml/document/model/paragraph';
import { parseRunProperties, RunProperties } from '@docx/ooxml/wordprocessingml/document/model/run';
