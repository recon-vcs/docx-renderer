import { DomType, OpenXmlElement, WmlBreak, WmlCharacter, WmlLastRenderedPageBreak, WmlNoteReference, WmlSymbol, WmlText } from '../document/dom';
import type { WmlRun } from '../document/run';
import { WmlFieldChar, WmlFieldSimple } from '../document/fields';
import { WmlCommentReference } from '../comments/elements';
