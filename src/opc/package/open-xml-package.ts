...
import { parseXmlString, XmlParser } from '@docx/xml/parsing/xml-parser';
import { splitPath } from '@docx/shared/utils';
import { parseRelationships, Relationship } from '@docx/opc/relationships/relationship';
