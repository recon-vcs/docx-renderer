// Regenerates accuracy/comparison-{light,dark}.svg from the latest docs/ACCURACY.md
...
const report = readFileSync(`${ROOT}/docs/ACCURACY.md`, 'utf8');

const summaryRows = [...report.matchAll(/^\| (.+?) \| \d+ \/ \d+ \| \*\*([\d.]+)%\*\* \|$/gm)];
if (summaryRows.length === 0) {
	console.error('No summary rows found in docs/ACCURACY.md — run `pnpm measure:all` first.');
	process.exit(1);
}
